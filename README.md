...
Hokan `0.1.0-beta.15` is the current public beta. The core terminal recovery
...
curl --proto '=https' --tlsv1.2 -LsSf \
  https://github.com/backrunner/hokan/releases/download/v0.1.0-beta.15/hokan-installer.sh \
  | HOKAN_VERSION=0.1.0-beta.15 sh
```
...
curl --proto '=https' --tlsv1.2 -LsSf \
  https://github.com/backrunner/hokan/releases/download/v0.1.0-beta.15/hokan-installer.sh \
  | HOKAN_VERSION=0.1.0-beta.15 HOKAN_ON_DEMAND=1 sh
```
...
| Variable | Purpose |
| --- | --- |
| `HOKAN_VERSION` | Install an exact release such as `0.1.0-beta.15` |
